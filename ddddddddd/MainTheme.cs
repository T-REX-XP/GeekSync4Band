...
namespace MainTheme
{
    public class DefControl : Control
    {
        private Color _inactiveColour = Color.FromArgb(0x51, 0x9b, 0xBE);
        public virtual Color InactiveColour { get { return _inactiveColour; } set { _inactiveColour = value; } }

        private Color _inactiveBorderColor = Color.FromArgb(0x51, 0x9b, 0xBE);
        public virtual Color InactiveBorderColor { get { return _inactiveBorderColor; } set { _inactiveBorderColor = value; } }

        private Color _pressedColor = Color.FromArgb(0x51, 0x9b, 0xBE);
        public virtual Color PressedColor { get { return _pressedColor; } set { _pressedColor = value; } }

        private Color _pressedBorderColor = Color.FromArgb(0x51, 0x9b, 0xBE);
        public virtual Color PressedBorderColor { get { return _pressedBorderColor; } set { _pressedBorderColor = value; } }
    ...
    class Apex_TextBox : Control
    {

        #region " Variables "

        private TextBox withEventsField_ApexTB = new TextBox();
        public TextBox ApexTB
        {
            get { return withEventsField_ApexTB; }
            set
            {
                if (withEventsField_ApexTB != null)
                {
                    withEventsField_ApexTB.TextChanged -= _TextChanged;
                }
                withEventsField_ApexTB = value;
                if (withEventsField_ApexTB != null)
                {
                    withEventsField_ApexTB.TextChanged += _TextChanged;
                }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            //   _with3.AddArc(0, 0, 10, 10, 180, 90);
            //   _with3.AddArc(Width - 11, 0, 10, 10, -90, 90);
            //   _with3.AddArc(Width - 11, Height - 11, 10, 10, 0, 90);
            //    _with3.AddArc(0, Height - 11, 10, 10, 90, 90);
            //  _with3.CloseAllFigures();
        }
        ...
        public void AddTextBox()
        {
            ...
            var _with4 = ApexTB;
            _with4.Size = new Size(Width - 10, 5);
            _with4.Location = new Point(5, 5);
            _with4.Text = string.Empty;
            _with4.BorderStyle = BorderStyle.None;
            _with4.TextAlign = HorizontalAlignment.Left;
            _with4.Font = new Font("Tahoma", 9);
            _with4.UseSystemPasswordChar = UseSystemPasswordChar;
            _with4.Multiline = false;
            _with4.BackColor = Color.FromArgb(245, 246, 247);
            ForeColor = Color.FromArgb(64, 64, 64);
            ApexTB.KeyDown += _OnKeyDown;
        }

        public Apex_TextBox()
        {
            TextChanged += _BaseTextChanged;
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null)
            {
                _with5.Width = Width - 10;
            }
            else
            {
                _with5.Width = Width - 35;
            }
            _with5.TextAlign = TextAlignment;
            _with5.UseSystemPasswordChar = UseSystemPasswordChar;

            G.DrawLine(new Pen(Color.FromArgb(180, 180, 180), 1), 0, Height - 2, 0, Height - Height);
            G.DrawLine(new Pen(Color.FromArgb(180, 180, 180), 1), Width - 2, Height - 2, Width - 2, Height - Height);

            //top line
            G.DrawLine(new Pen(Color.FromArgb(180, 180, 180), 1), 1, Height - Height, Width - 2, Height - Height);
            //baottom line
            G.DrawLine(new Pen(Color.FromArgb(180, 180, 180), 1), 1, Height - 2, Width - 2, Height - 2);
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        private int _headerSize = 60;
        public int HeaderHeigth { get { return _headerSize; } set { _headerSize = value; } }

        private Color _captionTextColor = Color.White;
        public Color CaptionTextColor { get { return _captionTextColor; } set { _captionTextColor = value; } }
        ...
        private Color _headerColor = Color.FromArgb(181, 41, 43);
        public Color HeaderColor { get { return _headerColor; } set { _headerColor = value; } }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //TODO: HEADER COlour and Heigth
            G.FillRectangle(new SolidBrush(_headerColor), new Rectangle(0, 0, Width, _headerSize));
            ...
            //TODO:                                                                                                 position of Title
            G.DrawString(Text, new Font("Segoe UI", 12, FontStyle.Bold), new SolidBrush(_captionTextColor), new Rectangle(10, 10, Width - 1, Height), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
        }
    }
    ...
    class MonoFlat_ControlBox : Control
    {
        ...
        private Color _backgroundColor = Color.FromArgb(0x61, 0x69, 0x80);
        public virtual Color BackgroundColor { get { return _backgroundColor; } set { _backgroundColor = value; } }
    ...
    class MonoFlat_ControlX : Control
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            try
            {
                Location = new Point(Parent.Width - 25, 10);
            }
            catch (Exception)
            {
            }
    ...
    public class MonoFlat_Button : DefControl
    {
        ...
        public MonoFlat_Button()
        {
            ...
            P1 = new Pen(InactiveBorderColor); // P1 = Border color
            P3 = new Pen(PressedBorderColor); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                inactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), InactiveColour, InactiveColour, 90.0F);
                pressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), PressedBorderColor, Color.FromArgb(165, 37, 37), 90.0F);
            }
    ...
    public class MonoFlat_Label : Label
    {
        ...
        {
            Font = new Font("Segoe UI", 9);
            ForeColor = Color.Green;  // Color.FromArgb(116, 125, 132);
            BackColor = Color.Transparent;
        }
    }
    ...
    public class MonoFlat_CheckBox : DefControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_Checked)
            {
                G.FillRectangle(new SolidBrush(PressedBorderColor), new Rectangle(0, 0, 16, 16));
            ...
            if (Enabled == true)
            {
                if (_Checked)
                {
                    ...
                    G.DrawString("a", new Font("Marlett", 16), new SolidBrush(PressedBorderColor), new Point(-5, -3));
                }
            }
            else
            {
    ...
    [DefaultEvent("TextChanged")]
    public class MonoFlat_TextBox : DefControl
    {
    ...
    public class MonoFlat_Separator : DefControl
    {
        private Color _backgroundColor = Color.FromArgb(0x51, 0x9b, 0xBE);
        public virtual Color BackgroundColor { get { return _backgroundColor; } set { _backgroundColor = value; } }
        ...
        {
            base.OnPaint(e);
            e.Graphics.DrawLine(new Pen(_backgroundColor), 0, 5, Width, 5);
        }
    }
